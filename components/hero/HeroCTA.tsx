...
export default function HeroCTA() {
  return (
    <motion.div 
      className="flex flex-row items-center gap-3 sm:gap-5 mt-8 sm:mt-12 w-full justify-center sm:w-auto"
      initial={{ opacity: 0, y: 10 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.6, duration: 0.8 }}
    >
      {/* --- THE AMBER GLOW BUTTON --- */}
      <button className="group relative px-5 py-2.5 sm:px-7 sm:py-2.5 rounded-full transition-all duration-500 overflow-hidden w-auto flex justify-center flex-1 sm:flex-none">
        ...
        <div className="relative z-10 flex items-center gap-2 text-white font-bold tracking-tight text-[11px] sm:text-[13px] uppercase whitespace-nowrap">
          Waitlist
      ...
      <button className="group relative px-5 py-2.5 sm:px-7 sm:py-2.5 rounded-full transition-all duration-500 w-auto flex justify-center flex-1 sm:flex-none">
        {/* Ultra-Thin Border */}
        ...
        <div className="relative z-10 flex items-center gap-2 text-slate-400 group-hover:text-white font-bold tracking-tight text-[11px] sm:text-[13px] uppercase transition-colors whitespace-nowrap">
          Learn More
